...
We have described three main types of vectors: numeric, character, and logical. In data science projects we very often encounter variables that are dates. Although we can represent a date with a string, for example, `October 31, 2022`, once we pick a reference day, referred to as the _epoch_, they can be converted to numbers. Computer languages usually use [January 1, 1970 as the epoch](https://www.quora.com/Why-does-epoch-time-start-with-January-1-1970). So, October 31, 2022 is day 19,296. 
